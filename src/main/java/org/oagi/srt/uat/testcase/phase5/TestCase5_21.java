...
public class TestCase5_21 {
    ...
    @Test
    public void testPromotingAdminUserRoleByEnterpriseAdmin() {
        CreateAccountInputs createAccountInputs = CreateAccountInputs.generateRandomly(random);
        createAccountInputs.setAddress(null);
        createAccountByEnterpriseAdmin(webDriver, createAccountInputs, UserRole.AdminUser);
        ...
        changeEnterpriseUserRole(webDriver, enterpriseAdmin.getLoginId(), "Revoke");
