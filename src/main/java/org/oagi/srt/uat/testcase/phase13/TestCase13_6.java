...
import static org.oagi.srt.uat.testcase.phase13.TestCase13_Helper.editContextScheme;
...
public class TestCase13_6 {
    ...
    @Test
    public void testEnterpriseEndUserCannotEditContextSchemeWithoutSchemeId() {
    ...
    @Test
    public void testEnterpriseEndUserCannotEditContextSchemeWithoutAgencyId() {
        String ctxCatName = createContextCategory(webDriver, random);
    ...
    @Test
    public void testEnterpriseEndUserCannotEditContextSchemeWithoutVersion() {
        String ctxCatName = createContextCategory(webDriver, random);
