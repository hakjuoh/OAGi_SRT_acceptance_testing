...
public class TestCase14_1_8 {
    ...
    public void testAdminUserCanDeleteContextCategoryCreatedByAnotherAdminUser() {
        ...
        deleteContextCategory(webDriver, ctxCatName);
        searchContextCategoryByName(webDriver, ctxCatName);
    }

    @Test(expected = TimeoutException.class)
    public void testAdminUserCanDeleteContextCategoryCreatedByEndUser() {
