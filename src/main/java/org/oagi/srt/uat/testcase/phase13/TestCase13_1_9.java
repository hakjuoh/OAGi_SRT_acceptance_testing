...
public class TestCase13_1_9 {
    ...
    public void testEndUserCanSeeAllContextCategories() {
        ...
        deleteContextCategory(webDriver, ctxCatName_1);
        assertNull(searchContextCategoryByName(webDriver, ctxCatName_1));
    }

    @Test(expected = TimeoutException.class)
    public void testEndUserCanDeleteCreatedContextCategoryByEndUser() {
        login(webDriver, enterpriseEndUser);

        String ctxCatName_2 = createContextCategory(webDriver, random);
        deleteContextCategory(webDriver, ctxCatName_2);
        assertNull(searchContextCategoryByName(webDriver, ctxCatName_2));
    }
