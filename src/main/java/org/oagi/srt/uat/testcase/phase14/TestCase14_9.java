...
public class TestCase14_9 {
    ...
    @Test
    public void testEnterpriseAdminUserCanEditContextSchemeValue() {
        ...
        editContextSchemeValue(webDriver, contextSchemeInputs, updateContextSchemeInputs.getValue(), updateContextSchemeInputs.getMeaning(), 0);

        click(searchContextSchemeByName(webDriver, contextSchemeInputs.getName()));

        findElementByText(webDriver, "div.ui-cell-editor-output", updateContextSchemeInputs.getValue());
    }
