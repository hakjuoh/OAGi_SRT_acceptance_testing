...
public class TestCase14_5 {
    ...
    @Test
    public void testEnterpriseEndUserCannotCreateContextSchemeWithoutContextCategory() {
        ...
        contextSchemeInputs.setContextCategory(null);
    ...
    @Test
    public void testEnterpriseEndUserCannotCreateContextSchemeWithoutName() {
        String ctxCatName = createContextCategory(webDriver, random);

        CreateContextSchemeInputs contextSchemeInputs = CreateContextSchemeInputs.generateRandomly(random, ctxCatName);
        contextSchemeInputs.setName(null);
        contextSchemeInputs.setValue(null);
        contextSchemeInputs.setMeaning(null);
        createContextScheme(webDriver, contextSchemeInputs);
    ...
    @Test
    public void testEnterpriseEndUserCannotCreateContextSchemeWithoutSchemeId() {
        String ctxCatName = createContextCategory(webDriver, random);
    ...
    @Test
    public void testEnterpriseEndUserCannotCreateContextSchemeWithoutAgencyId() {
        String ctxCatName = createContextCategory(webDriver, random);
    ...
    @Test
    public void testEnterpriseEndUserCannotCreateContextSchemeWithoutVersion() {
        String ctxCatName = createContextCategory(webDriver, random);
