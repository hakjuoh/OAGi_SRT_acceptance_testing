...
public class TestCase17_3 {
    ...
    @Test
    public void testEnterpriseAdminUserCanChangePassword() {
        ...
        logout(webDriver);
        login(webDriver, enterpriseAdmin.getLoginId(), updateAccountInfos.getPassword(), true);
    }
