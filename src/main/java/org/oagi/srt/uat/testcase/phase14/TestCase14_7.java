...
public class TestCase14_7 {
    ...
    @Test
    public void testEnterpriseAdminUserCanAddContextSchemeValue() {
        ...
        addContextSchemeValue(webDriver, contextSchemeInputs, updateContextSchemeInputs.getValue(), updateContextSchemeInputs.getMeaning(), 1);
