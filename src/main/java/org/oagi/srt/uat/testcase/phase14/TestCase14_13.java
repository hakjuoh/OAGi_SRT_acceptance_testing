...
import static org.oagi.srt.uat.testcase.phase14.TestCase14_Helper.editCodeList;
...
public class TestCase14_13 {
    ...
    @Test
    public void testEnterpriseAdminUserCannotEditCodeListWithoutName() {
        CreateCodeListInputs codeListInputs = createCodeListWithoutBase(webDriver, random);
        String name = codeListInputs.getName();
        codeListInputs.setName(null);

        editCodeList(webDriver, name, codeListInputs);
    ...
    @Test
    public void testEnterpriseAdminUserCannotEditCodeListWithoutAgencyId() {
        CreateCodeListInputs codeListInputs = createCodeListWithoutBase(webDriver, random);
        codeListInputs.setAgencyId(null);

        editCodeList(webDriver, codeListInputs.getName(), codeListInputs);
    ...
    @Test
    public void testEnterpriseAdminUserCannotEditCodeListWithoutVersion() {
        CreateCodeListInputs codeListInputs = createCodeListWithoutBase(webDriver, random);
        codeListInputs.setVersion(null);
